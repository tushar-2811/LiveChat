...
const USER_BASE_URL = process.env.NEXT_PUBLIC_USER_SERVICE_URL || process.env.USER_SERVICE_URL || "http://13.203.224.218:4000";

const CHAT_BASE_URL = process.env.NEXT_PUBLIC_CHAT_SERVICE_URL || process.env.CHAT_SERVICE_URL || "http://13.203.224.218:4005";
